...
var result = new List<Gw2WikiDownload.AchievementTableEntry>();
...
{
    if (item.Description is Gw2WikiDownload.CollectionDescription collectionDescription)
    {
...
foreach (var item in result)
{
    if (item.Reward is Gw2WikiDownload.ItemReward reward)
    {
